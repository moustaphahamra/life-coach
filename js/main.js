...
function documentReadyInit() {
    ...
    if (jQuery().owlCarousel) {
        jQuery('.owl-carousel').each(function() {
            ...
            if (dots) {
                //custom nav
                $carousel.find('.owl-dots:not([style*="none"])')
                    .wrap('<div class="owl-custom-nav"/>')
                    .before('<div class="owl-custom-prev"><i class="fa fa-angle-left"></i></div>')
                    .after('<div class="owl-custom-next"><i class="fa fa-angle-right"></i></div>')
                    .end()
    ...
    if (jQuery().flexslider) {
        ...
        $introSlider.each(function(index) {
            ...
            $currentSlider.flexslider({
                ...
                .before('<a class="flex-custom-prev flex-custom-link" href="#"><i class="fa fa-angle-left"></i></a>')
                .after('<a class="flex-custom-next flex-custom-link" href="#"><i class="fa fa-angle-right"></i></a>');
